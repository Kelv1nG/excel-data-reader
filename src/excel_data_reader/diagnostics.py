...
class DiagnosticCode(StrEnum):
    ...
    MATRIX_SECTION_NOT_FOUND = "MATRIX_SECTION_NOT_FOUND"
    AMBIGUOUS_MATRIX_SECTION = "AMBIGUOUS_MATRIX_SECTION"
    MATRIX_HEADER_NOT_FOUND = "MATRIX_HEADER_NOT_FOUND"
    MATRIX_IDENTIFIER_NOT_FOUND = "MATRIX_IDENTIFIER_NOT_FOUND"
    AMBIGUOUS_IDENTIFIER_COLUMN = "AMBIGUOUS_IDENTIFIER_COLUMN"
    INVALID_MATRIX_QUERY = "INVALID_MATRIX_QUERY"
    MISSING_ROW_IDENTIFIER = "MISSING_ROW_IDENTIFIER"
    DUPLICATE_MATRIX_HEADER = "DUPLICATE_MATRIX_HEADER"
